...
An initial overview of the data can be conducted via the `View`, `head` or `glimpse` functions. The dataset contains `dim(training.raw[1])` data entries or rows and `dim(training.raw[2])` variables or columns. However, it is clear from the data overview shown below that some variables are not needed for model building. 
